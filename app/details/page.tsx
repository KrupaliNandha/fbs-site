  ...
  return (
    <div>
      ...
      <h3 className="mt-8 text-sm font-semibold text-gray-900">
        Template Download <span className="font-normal text-gray-500">(</span>
        <a href="#" className="font-normal text-[#2ca5e0] hover:underline">
          Template User Guide
        </a>
        <span className="font-normal text-gray-500">)</span>
      </h3>
      <div className="mt-3 overflow-x-auto">
        <table className="w-full max-w-3xl text-sm border-collapse min-w-[600px] border border-gray-200">
          <thead className="bg-[#f8f8f8]">
            <tr>
              <th className="font-semibold text-gray-800 p-3 text-center border-b border-r border-gray-200 w-32">
                Size
              </th>
              <th className="font-semibold text-gray-800 p-3 text-center border-b border-r border-gray-200">
                <div className="flex flex-col items-center justify-center gap-1.5">
                  <span className="bg-[#cc0000] text-white text-[10px] font-bold px-1.5 py-2 rounded-sm leading-none">
                    PDF
                  </span>
                  <span>PDF</span>
                </div>
              </th>
              <th className="font-semibold text-gray-800 p-3 text-center border-b border-gray-200">
                <div className="flex flex-col items-center justify-center gap-1.5">
                  <span className="bg-[#2a7bbd] text-white text-[12px] font-bold px-2 py-2 rounded-sm leading-none">
                    Ps
                  </span>
                  <span>Photoshop</span>
                </div>
          ...
          <tbody>
            {data.templates.map((row) => (
              <tr key={row.size} className="align-top">
                <td className="p-4 font-medium text-gray-900 whitespace-nowrap text-center border-b border-r border-gray-200 align-middle">
                  {row.size}
                </td>
      ...
      {data.instructions && data.instructions.length > 0 && (
        <ul className="mt-6 space-y-1.5 list-disc pl-5 text-sm text-gray-700">
