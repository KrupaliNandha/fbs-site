...
// Path is relative to THIS file: app/services/web-design/[slug]/page.tsx
// -> up 4 levels to project root, then into /data/web-design.json
// Adjust if your data file lives somewhere else.
...
// Maps the "icon" string stored in the JSON to an actual lucide-react component
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-24">
              <div className="relative">
                ...
                {/* Floating highlight badge — signature element echoed from homepage */}
            ...
            <div className="pt-2 lg:pt-8">
              ...
              {/* Feature grid — spec-sheet style instead of a plain list */}
